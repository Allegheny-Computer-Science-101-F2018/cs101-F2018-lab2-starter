...
# cs101-F2018-lab2-solution

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the solution for Laboratory 2 in Computer Science 101.
...
responsible for learning how to run and extend a test suite written in the
JUnit testing framework, as explained in Section 1.9. As verified by
[Checkstyle](https://github.com/checkstyle/checkstyle), the source code for the
for all of the Java source code files must adhere to all of the requirements in
...
The Java source code files must also pass additional tests set by the
[GatorGrader tool](https://github.com/GatorEducator/gatorgrader). For instance,
GatorGrader will check to ensure that `SentencesReverser` has `println`
statements that produce exactly twenty-six lines of output. GatorGrader will
also check that your program performs the correct reversal of an array,
ensuring that it produces output that contains certain fragments. More details
...
other Java classes have methods that you must correctly implement to ensure
that the `SentencesReverser` produces the correct output.
...
- labtwo/SentencesReverser.java:
  - Contains at least nine multi-line comments in the JavaDoc standard
  - Contains exactly five `println` statements to produce program output
  - Runs correctly without crashing or producing an error
  - Produces exactly twenty-six lines of output in the terminal
  - Produces output that contains exactly two of the fragment `First`
  - Produces output that contains exactly two of the fragment `Tenth`
  - Produces output that contains exactly three of the fragment `Done`

- labtwo/TestSentences.java:
  - Contains at least three test cases decorated with the `@Test` annotation
...
you can go to the [Computer Science 101 Lab 2
Starter](https://github.com/Allegheny-Computer-Science-101-F2018/cs101-F2018-lab2-starter)
